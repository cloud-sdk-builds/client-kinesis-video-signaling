...
[`@aws-sdk/client-kinesis-video-signaling`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-video-signaling/v/3.890.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video-signaling@3.890.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-96CPHfqFFYUxmVd69EKmOdyyL1mxBhxc5/t+0GioESwd+Sw2l60iv/X2+UyxJpeR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-video-signaling": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video-signaling@3.890.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-video-signaling@3.890.0/index.min.mjs": "sha384-96CPHfqFFYUxmVd69EKmOdyyL1mxBhxc5/t+0GioESwd+Sw2l60iv/X2+UyxJpeR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-video-signaling/blob/refs/tags/3.890.0/LICENSE
```
